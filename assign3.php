...
<input type = "radio" name = "order" id="DesA">Ascending by Description<br>
<input type = "radio" name = "order" id="DesD">Descending by Description<br>
<input type = "radio" name = "order" id="CosA">Ascending by Cost<br>
<input type = "radio" name ="order" id="CosD">Descending by Cost<br>
<p>
<hr>
<p> 
